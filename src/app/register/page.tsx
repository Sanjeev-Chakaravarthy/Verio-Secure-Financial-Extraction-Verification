...
function RegisterForm() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // On success browser redirects, no need to reset
    } catch {
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-lg">
            ...
            <div className="pt-md flex flex-col gap-md">
              ...
              <button
                ...
                className="w-full bg-transparent hover:bg-surface-container-low text-primary py-md px-xl font-sans text-label-sm text-[12px] uppercase tracking-widest transition-all rounded-none border border-outline-variant flex items-center justify-center gap-md disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {googleLoading ? (
                  <>
